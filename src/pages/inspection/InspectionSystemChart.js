...
// // // // //   getPaddedYDomain = (rows, keys, padRatio = 0.1) => {
// // // // //     try {
// // // // //       const vals = [];
// // // // //       (rows || []).forEach((row) =>
// // // // //         (keys || []).forEach((k) => {
...
// // // // //                   <Typography
// // // // //                     variant="subtitle2"
// // // // //                     sx={{ fontWeight: 800, color: "#546e7a", mb: 0.5, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}
// // // // //                     title={label}
// // // // //                   >
// // // // //                     {label}
// // // // //                   </Typography>
...
// // // // //                     {/* 내부 고정폭 박스 (가로 스크롤 대상) */}
// // // // //                     <Box sx={{ width: `${fullWidth}px`, height: 280 }}>
// // // // //                       <LineChart width={fullWidth} height={280} data={data} margin={{ top: 8, right: 12, left: 0, bottom: 0 }}>
// // // // //                         <CartesianGrid strokeDasharray="3 3" />
// // // // //                         <XAxis
// // // // //                           dataKey="idx"
// // // // //                           ticks={dayTicks}      // ✅ 날짜가 바뀌는 지점만 눈금
// // // // //                           interval={0}          // 제공된 ticks만 사용
// // // // //                           tickLine
// // // // //                           tickMargin={8}
// // // // //                           tickFormatter={(v) => {
// // // // //                             const item = data[v - 1];
...
// // // // //                           }}
// // // // //                         />
// // // // //                         <YAxis domain={this.getPaddedYDomain(data, ["y"])} allowDataOverflow />
// // // // //                         <RTooltip
...
// // // //                   <Typography variant="caption" sx={{ color: "#78909c", mt: 0.5, display: "block" }}>
// // // //                     X축은 각 날짜마다 <b>주간 X1→Xn</b>을 먼저, 이어서 <b>야간 X1→Xn</b> 순서로 붙입니다.
// // // //                     한 화면에는 보고일 5개씩 보이며, 날짜가 바뀌는 지점에서만 눈금이 표시됩니다.
// // // //                   </Typography>
// // // //                 </Paper>
// // // //               );
// // // //             })}
...
// // //  *  - "기준 ± 공차"  → 예: "1145.0 ±0.3"
// // //  *  - "저~고"        → 예: "1145.9~1146.8"
// // //  *  - "Ø기준,+공차"  → 예: "ø13.5, +0.2mm 이내"  (대칭 공차 가정)
// // //  */
// // // const parseSpecRange = (specText) => {
// // //   const t = (specText || "").replace(/\s+/g, " ").trim();
...
// // //   // 3) "ø13.5, +0.2,mm 이내" → center ± tol(대칭 가정)
// // //   m = t.match(/(?:ø|Ø)?\s*([-+]?\d+(?:\.\d+)?)\D+\+?([-+]?\d+(?:\.\d+)?)/i);
// // //   if (m) {
