      ...
      <div className={s.container}>
        ...
        <div className={s.mainContent}>
          <div className={s.welcomeSection}>
            <h2>생산관리 시스템에 오신 것을 환영합니다</h2>
            <p>생산 현황을 모니터링하고 관리할 수 있는 다양한 도구를 제공합니다.</p>
          </div>

          <div className={s.menuGrid}>
            <Link to="/app/production/chart" className={s.menuCard}>
              ...
              <h3>생산데이터 차트</h3>
              <p>월별 생산 목표 대비 실적을 차트로 확인하고 분석합니다.</p>
              <div className={s.menuArrow}>→</div>
            </Link>

            <Link to="/app/production/grid" className={s.menuCard}>
              <div className={s.menuIcon}>
                <svg viewBox="0 0 24 24" fill="currentColor">
              ...
              <h3>생산 데이터 그리드</h3>
              <p>생산 현황을 상세한 테이블 형태로 확인하고 관리합니다.</p>
              <div className={s.menuArrow}>→</div>
            </Link>
          </div>
          ...
          <div className={s.quickStats}>
            <div className={s.statCard}>
              <h4>오늘의 생산량</h4>
              <div className={s.statValue}>1,250</div>
              <div className={s.statUnit}>개</div>
            </div>
            <div className={s.statCard}>
              <h4>가동률</h4>
              <div className={s.statValue}>98.5%</div>
              <div className={s.statUnit}>현재</div>
            </div>
            <div className={s.statCard}>
              <h4>효율성</h4>
              <div className={s.statValue}>102.3%</div>
              <div className={s.statUnit}>목표 대비</div>
            </div>
          </div>
        </div>
      </div>
